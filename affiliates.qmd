...
The R Repositories Working Group has been focused on [understanding the CRAN checks with the goal of improving transparency](https://github.com/RConsortium/r-repositories-wg/blob/main/Documents/Proposal%20to%20CRAN.md). Their remit includes shaping the R ecosystem to support spaces such as the pharma community, which makes them a key partner.
